package br.com.grupo99.catalogo.infrastructure.security.jwt;
...
public class JwtAuthorizationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
        ...
        if ("CLIENTE".equals(perfil)) {
            ...
            if ("/api/v1/servicos".equals(requestURI) || "/api/v1/pecas".equals(requestURI)) {
            ...
            if (!"GET".equals(method)) {
                ...
                response.setContentType("application/json");
                response.getWriter()
                        .write("{\"error\":\"Acesso negado. Clientes só podem consultar serviços e peças.\"}");
                return;
            }
