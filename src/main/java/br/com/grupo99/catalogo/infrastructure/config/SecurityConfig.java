package br.com.grupo99.catalogo.infrastructure.config;

import br.com.grupo99.catalogo.infrastructure.security.jwt.JwtAuthorizationFilter;
import br.com.grupo99.catalogo.infrastructure.security.jwt.JwtRequestFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http.csrf(csrf -> csrf.disable())
                .authorizeHttpRequests(auth -> auth
                        // GET requests para servicos e pecas podem ser autenticados
                        .requestMatchers(HttpMethod.GET, "/api/v1/servicos/**").authenticated()
                        .requestMatchers(HttpMethod.GET, "/api/v1/pecas/**").authenticated()
